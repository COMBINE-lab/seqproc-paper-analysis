...
TOOL_CONFIGS = {
    "splitseq_pe": {
        ...
        "mode": "paired",
        "seqproc_edit_geom": CONFIGS / "seqproc/publication_splitseq_pe.geom",
        "seqproc_hamming_geom": CONFIGS / "seqproc/splitseq_filter_hamming6.geom",
        "seqproc_geom": CONFIGS / "seqproc/publication_splitseq_pe.geom",
        "matchbox_config": CONFIGS / "matchbox/publication_splitseq_pe.mb",
        "matchbox_paired": True,
        "splitcode_config": CONFIGS / "splitcode/publication_splitseq_pe.config",
        "splitcode_x_only": True,
        "splitcode_extract_name": "umi_bc3_bc2_bc1.fastq",
    ...
    "lr_splitseq": {
        ...
        "mode": "single",
        "seqproc_edit_geom": CONFIGS / "seqproc/publication_lr_splitseq_dual_core.geom",
        "seqproc_hamming_geom": CONFIGS / "seqproc/splitseq_singleend_ann.geom",
        "seqproc_fw_edit_geom": CONFIGS / "seqproc/publication_lr_splitseq_forward_core.geom",
        "seqproc_fw_hamming_geom": CONFIGS / "seqproc/splitseq_singleend.geom",
        "seqproc_geom": CONFIGS / "seqproc/publication_lr_splitseq_dual_core.geom",
        "matchbox_config": CONFIGS / "matchbox/publication_lr_splitseq_dual_core.mb",
        "matchbox_paired": False,
        "splitcode_config": CONFIGS / "splitcode/publication_lr_splitseq_core.config",
        "splitcode_x_only": True,
        "splitcode_extract_name": "prefix.fastq",
        "tools": ["seqproc", "matchbox", "splitcode"],
    },
    "10x_short": {
        ...
        "matchbox_config": CONFIGS / "matchbox/publication_10x_v2.mb",
        "matchbox_paired": True,
        "splitcode_config": CONFIGS / "splitcode/publication_10x_v2_filter.config",
        "splitcode_x_only": False,
        "tools": ["seqproc", "matchbox", "splitcode"],
    },
    "sciseq": {
        "name": "sci-RNA-seq3",
        ...
        "matchbox_config": CONFIGS / "matchbox/publication_sciseq3.mb",
        "matchbox_paired": True,
        "splitcode_config": CONFIGS / "splitcode/sciseq3.config",
        "splitcode_x_only": True,
        "splitcode_extract_name": "splitcode_sci_rna_seq3.fastq",
        "tools": ["seqproc", "matchbox", "splitcode"],
    },
}
